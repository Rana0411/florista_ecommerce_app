...
import '../screen/login_cubit.dart';
import '../widget/buttons/guest_buon.dart';
import '../widget/buttons/login_button.dart';
import '../widget/buttons/signup_button.dart';

/// Public entry point — owns its own [BlocProvider] so the router
/// can use `LoginView()` with no extra setup.
...
class _LoginBodyState extends State<_LoginBody> {
  ...
  void _onStateChanged(BuildContext context, BaseState<LoginEntity> state) {
    if (state.data != null) {
